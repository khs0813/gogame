...
interface ImportMetaEnv {
  ...
  readonly VITE_ADFIT_RULES_DESKTOP?: string;
  readonly VITE_ADFIT_RULES_MOBILE?: string;
  readonly VITE_ADFIT_RULES_SECONDARY_DESKTOP?: string;
  readonly VITE_ADFIT_RULES_SECONDARY_MOBILE?: string;
